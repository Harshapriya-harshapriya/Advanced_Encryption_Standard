...

{
    ...
    float Avalanche_effect,changed_bits=0.0;
...
//     Part 1: ********************************************************
    ...
    unsigned char temp2[16]= {'T'  ,'h'  ,'i' ,'s'  ,' '  ,'i'  ,'s'  ,' '  ,'a' ,' ' ,'t'  ,'e' ,'s'  ,'t'  ,' '  ,' '};
    ...
    unsigned char tempk[16] = {0x00  ,0x01  ,0x02  ,0x03  ,0x04  ,0x05  ,0x06  ,0x07  ,0x08  ,0x09  ,0x0a  ,0x0b  ,0x0c  ,0x0d  ,0x0e  ,0x0f};

    unsigned char temp3[16]= {'T'  ,'h'  ,'i' ,'s'  ,' '  ,'i'  ,'s'  ,' '  ,'a' ,' ' ,'t'  ,'e' ,'s'  ,'t'  ,' '  ,' '};

   // unsigned char temp3[16]= {0x00  ,0x11  ,0x22  ,0x33  ,0x44  ,0x55  ,0x66  ,0x77  ,0x88  ,0x99  ,0xaa  ,0xbb  ,0xcc  ,0xdd  ,0xee  ,0xff};
   ...
   //XOR operation between two Encrypted outputs
   ...
   // Here Number of changed bits between two encrypted outputs is calculated
    ...
    Avalanche_effect=(changed_bits/128)*100;

 // Printing Number of changed bits and Avalanche effect

   printf("Number of changed bits=%f\n\n",changed_bits);

     printf("Avalanche effect=%f %%\n",Avalanche_effect);
